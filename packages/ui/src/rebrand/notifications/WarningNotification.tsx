...
const WarningNotification = ({ text, title, showIcon }: WarningNotificationProps) => {
  return (
    <div className="relative w-full sm:max-w-[280px] md:max-w-[360px] lg:max-w-full text-base bg-bananaBoat/10 text-bananaBoat pt-[15px] pr-[22px] pb-[25px] pl-[50px] global-cta-clip-path">
