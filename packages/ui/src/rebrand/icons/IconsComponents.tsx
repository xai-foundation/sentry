...
export const KeyIcon = ({ extraClasses = "fill-[#A19F9F]" , width = 16 }) => {
  return <svg className={extraClasses} width={width} height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
