...
export function LogoColumn(): JSX.Element {
    return (
        <div className="flex flex-col justify-start items-center h-auto px-4 py-4 lg:p-12 xg:pl-[80px] lg:pt-1 ">
            {/* Logo container */}
            ...
            <div className="w-full flex justify-center lg:max-w-[280px]">
                <span className="text-4xl lg:text-6xl text-center font-bold text-white">
