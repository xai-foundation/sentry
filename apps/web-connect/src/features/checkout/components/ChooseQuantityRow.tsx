...
export function ChooseQuantityRow(): JSX.Element {
	...
	return (
		<div>
			<div className="flex flex-col lg:flex-row justify-between lg:items-start items-center">
				{/* Information section */}
				<div className="flex flex-col items-center lg:items-start gap-2">
					{/* Title and icon section */}
					<div className="flex flex-row w-full justify-center lg:justify-start items-center gap-1">
					...
					<p className="w-full lg:w-[400px] text-center px-8 lg:px-0 lg:text-left text-[18px] text-elementalGrey font-medium">
						Each Sentry Node Key enables you to submit up to 1 reward claim for each network challenge.
					</p>
				</div>
				{/* Quantity input section */}
				<div className="flex w-full justify-end flex-row items-start gap-4 mt-4 lg:mt-10">
					<div className="flex w-full lg:w-[175px] px-2 lg:px-0">
			...
			{quantity > MAX_PER_PURCHASE && <BaseCallout
                extraClasses={{calloutWrapper: "md:h-[100px] h-[159px] mt-[12px]", calloutFront: "!justify-start"}}
                isWarning>
