					...
					<>
						...
						<div className="flex flex-col justify-center gap-8 mt-8">
							...
							<div>
								<PrimaryButton
									onClick={() => onClick()}
									className={`w-full h-16 ${checkboxOne && checkboxTwo && checkboxThree ? "bg-[#F30919] global-clip-path" : "bg-gray-400 cursor-default !text-[#726F6F]"} text-[20px] text-white p-2 uppercase font-bold`}
									isDisabled={!ready}
									btnText={chain?.id === 42_161 || chain?.id === 42_1614 ? "BUY NOW" : "Please Switch to Arbitrum One"}
								/>
