...
export function ReactCookieConsent({ }) {
	...
	return (
		<CookieConsent
			...
			style={{ backgroundColor:" rgba(24, 20, 21, 0.70)", textAlign: "center", fontFamily: "Rajdhani, sans-serif", margin: "0", fontWeight: "600", padding: "0", justifyContent: "center", alignItems: "center", clipPath: "polygon(15px 0, 100% 0, 100% calc(100% - 15px), calc(100% - 15px) 100%, 0 100%, 0 15px)", minHeight: "51px", maxWidth: "100%" }}
		...
		>
			<div className="cookie-consent flex items-center text-white text-[18px] lg:w-[90%] opacity-70 !m-0">
				<div className="min-w-[30px] mr-2"><WarningIcon fill="#FF0030" width={30} height={25}/></div>
				<div className="sm:mb-4 md:mb-0 lg:mb-0">This website uses cookies to enhance the user experience. By staying on this website you agree to our <a target="_blank" className="mx-2 hover:text-white duration-200 ease-in" href="https://xai.games/generalterms">Terms of Agreement</a> and <a target="_blank" className="ml-2 hover:text-white duration-200 ease-in" href="https://xai.games/privacypolicy">Privacy Policy</a></div>
			</div>
		</CookieConsent>
	);
}