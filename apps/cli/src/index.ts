...
import { addPromoCodeList } from './commands/licenses/add-promo-code-list.js';
...
import { bulkMintNodeLicenses } from './commands/bulk-mint-node-licenses.js';
