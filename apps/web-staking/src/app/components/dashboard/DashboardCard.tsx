    ...
    <>
      {address ? (
        <section
          ...
          <span className="dashboard-text-gradient block w-full pl-[24px] text-[40px] xl:text-[54px]">
            {esXaiBalance} esXAI
          </span>
          <span className="dashboard-text-gradient mt-2 block pl-[24px] text-[32px] leading-none">
            {xaiBalance} XAI
          </span>
          <span className="mt-2 block pl-[24px] xl:mt-8">Sentry keys</span>
          <span className="dashboard-text-gradient block pl-[24px] text-[32px]">
