...
const DashboardPromo = ({ chainId }: DashboardPromoProps) => {
  ...
  return (
    <section className="relative flex w-full flex-col items-center overflow-hidden bg-crystalWhite py-0 md:py-[50px] xl:px-0">
      <div className="relative z-10 order-2 mt-8 md:mt-0 w-full max-w-[928px] px-5 ">
