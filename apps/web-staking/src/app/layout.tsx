  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" property="og:description" content="Stake keys and esXai to earn rewards"/>
        ...
        <meta name="twitter:description" content="Stake keys and esXai to earn rewards"/>
