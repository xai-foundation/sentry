	...
	function getNodeFunds() {
		return (
			<BaseCallout
				...
				extraClasses={{ calloutWrapper: `absolute bottom-4 left-6 w-[328px] !p-0 flex justify-center items-center gap-1 ${nodeStatus ? "text-lg !text-[#3DD68C] !bg-drunkenDragonFly/10" : "text-lg text-bananaBoat bg-[#FFC53D1A]"}`, calloutFront: "!justify-start" }}>
				...
				{sentryRunning ? (
					...
					<>
						...
						<div
							...
							<PrimaryButton
								className={`w-[643px] text-[20px] uppercase font-semibold mt-2 !global-cta-clip-path`}
